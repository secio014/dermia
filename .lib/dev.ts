...
//
// Para testar a tela de login real durante o desenvolvimento, rode com
// EXPO_PUBLIC_FORCAR_LOGIN=1 (ou defina no .env) — aí o bypass é desligado.
export const LOGIN_DESATIVADO = __DEV__ && process.env.EXPO_PUBLIC_FORCAR_LOGIN !== '1';
